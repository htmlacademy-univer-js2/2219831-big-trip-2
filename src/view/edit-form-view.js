import AbstractStatefulView from '../framework/framework/view/abstract-stateful-view.js';
      ...
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <input class="event__input  event__input--destination" id="event-destination-${destination}" type="text"
           name="event-destination" value="${destinationData ? he.encode(destinationData.name) : ''}" list="destination-list-1">
...
export default class EditeFormView extends AbstractStatefulView  {
  #destination = null;
  #offers = null;
  #datepickerFrom = null;
  #datepickerTo = null;
  ...
  constructor({point = BLANK_POINT, destination, offers, isNewPoint}) {
    super();
    this._state = EditeFormView.parsePointToState(point);
  ...
  reset = (point) => {
    this.updateElement(
      EditeFormView.parsePointToState(point),
    );
  };
  ...
  #formSubmitHandler = (evt) => {
    evt.preventDefault();
    this._callback.formSubmit(EditeFormView.parseStateToPoint(this._state));
  };
  ...
  #formResetClickHandler = (evt) => {
    evt.preventDefault();
    this._callback.resetClick(EditeFormView.parseStateToPoint(this._state));
  };
